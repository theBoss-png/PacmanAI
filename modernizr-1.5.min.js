...
window.Modernizr = (function (i, e, I) {
      ...
      for (var b = 0, c, h = a.length; b < h; b++) {
        ...
        if ((c = n.type !== "text")) {
          ...
          /tel|search/.test(n.type) ||
            (c = /url|email/.test(n.type)
              ? n.checkValidity && n.checkValidity() === false
              : n.value != K);
        }
        L[a[b]] = !!c;
      }
  ...
  d.canvastext = function () {
    return !!(
      d.canvas() &&
      typeof e.createElement("canvas").getContext("2d").fillText == "function"
    );
  };
  ...
  d.cssgradients = function () {
    var a = (
      ...
      y.join("linear-gradient(left top,#9f9, white);background-image:")
    ).slice(0, -17);
    m.cssText = a;
    ...
    if (/*@cc_on@if(@_jscript_version>=5)!@end@*/ 0) a = true;
      ...
      var v = function () {
        if (g.parentNode) {
          ...
          s.className =
            s.className.replace(/(no-)?fontface\b/, "") +
            (a ? " " : " no-") +
            "fontface";
        }
      };
  ...
  d.smil = function () {
    return (
      !!e.createElementNS &&
      /SVG/.test(
        M.call(e.createElementNS("http://www.w3.org/2000/svg", "animate")),
      )
    );
  };
  d.svgclippaths = function () {
    return (
      !!e.createElementNS &&
      /SVG/.test(
        M.call(e.createElementNS("http://www.w3.org/2000/svg", "clipPath")),
      )
    );
  };
  for (var z in d)
